...
public class Pokedex1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tf4_ins.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tf4_insActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(tf5_ins, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(tf6_ins, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_insActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_insActionPerformed
        try {
            ...
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Entrenador(Nombre,Genero,Rol) values('"+at1+"','"+at2+"',"+"'"+at3+"')");
                break; 
                case 2:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Generacion(Numero,Region,Legendario1,Legendario2) values("+at1+",'"+at2+"','"+at3+"','"+at4+"')");
                break; 
                case 3:
             
            statement = dbConnection.createStatement();
            resultado = statement.executeUpdate("insert into Movimiento(Nombre,Numero,Tipo1,Tipo2,Descripcion,Objeto_Nombre,Generacion_Numero) values('"+at1+"',"+at2+",'"+at3+"','"+at4+"','"+at5+"',null,"+at6+")");                break; 
                case 4:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Profesor(Nombre,Numero,Tipo1,Tipo2,Descripcion,Objeto_Nombre,Generacion_Numero) values('"+at1+"',"+at2+",'"+at3+"','"+at4+"','"+at5+"',null,"+at6+")");
                break; 
                case 6:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Gimnasio(Nombre,Numero,Tipo1,Tipo2,Descripcion,Objeto_Nombre,Generacion_Numero) values('"+at1+"',"+at2+",'"+at3+"','"+at4+"','"+at5+"',null,"+at6+")");
                break; 
                case 7:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Lider(Nombre,Numero,Tipo1,Tipo2,Descripcion,Objeto_Nombre,Generacion_Numero) values('"+at1+"',"+at2+",'"+at3+"','"+at4+"','"+at5+"',null,"+at6+")");
                break; 
                case 8:
            
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("insert into Objeto(Nombre,Numero,Tipo1,Tipo2,Descripcion,Objeto_Nombre,Generacion_Numero) values('"+at1+"',"+at2+",'"+at3+"','"+at4+"','"+at5+"',null,"+at6+")");
                break; 
            }
            if(resultado>0){
    ...
    private void tf4_insActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf4_insActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tf4_insActionPerformed
    ...
    private void btn_actActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actActionPerformed
     try {
            ...
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("update Pokemon set numero ="+ at2+" where nombre = '"+at1+"';" );
                break;
                case 1:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("update Entrenador set genero ='"+ at2+"' where nombre = '"+at1+"';" );
                break; 
                case 2:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("update Generacion set region ='"+ at2+"' where numero = "+at1+";" );
                break; 
                case 3:
    ...
    try {
            ...
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from pokemon where nombre = '"+at1+"'");
                break;
                case 1:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Entrenador where nombre = '"+at1+"'");
                break; 
                case 2:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Generacion where nombre = '"+at1+"'");
                break; 
                case 3:
             
            statement = dbConnection.createStatement();
            resultado = statement.executeUpdate("delete from Movimiento where nombre = '"+at1+"'");                
                break; 
                case 4:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Profesor where nombre = '"+at1+"'");
                break; 
                case 6:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Gimnasio where nombre = '"+at1+"'");
                break; 
                case 7:
             
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Lider where nombre = '"+at1+"'");
                break; 
                case 8:
            
            statement = dbConnection.createStatement();
             resultado = statement.executeUpdate("delete from Objeto where nombre = '"+at1+"'");
                break; 
            }
            if(resultado>0){
    ...
    }//GEN-LAST:event_btn_borActionPerformed
